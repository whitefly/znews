...
<head>
    ...
    <link href="https://static.zhihu.com/static/components/respond/cross-domain/respond-proxy.html" id="respond-proxy"
          rel="respond-proxy"/>
    <link href="/static/components/respond/cross-domain/respond.proxy.gif" id="respond-redirect"
                ...
                <form novalidate="novalidate" method="post" id="myForm">
                    ...
                    <div class="group-inputs">
                        ...
                        <div class="input-wrapper captcha-module" data-type="en">
                            <input id="captcha" name="" placeholder="验证码" required="" data-rule-required="true"
                                   data-msg-required="请填写验证码" class="is-ignoreValidation">
                            <div class="captcha-container">
                                <img class="js-refreshCaptcha captcha" width="120" height="30" data-tip="s$t$看不清楚？换一张"
                                     alt="验证码">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="Captcha input-wrapper" data-type="cn" data-za-module="Captcha">
                            <div class="Captcha-operate">
                                <input type="hidden" name="captcha" required="" data-rule-required="true"
                                       data-msg-required="请点击图中倒立的文字" value="">
...
<script type="text/json" class="json-inline" data-name="ga_vars">
    {"user_created":0,"now":1467946521000,"abtest_mask":"------------------------------","user_attr":[0,0,0,"-","-"],"user_hash":0}
...
<script type="text/template" class="register-template">
    ...
    <div class="view register SignupForm">
        <form action="/register/email">
            ...
            <div class="input-wrapper">
                <input type="text" name="phone_num" class="account" data-is-domestic="true" aria-label="手机号（仅支持中国大陆）"
                       placeholder="手机号（仅支持中国大陆）" required>
            </div>
    ...
    <div class="view verification">
        <form>
            ...
            <div class="input-wrapper verification-code">
                <input type="text" name="verification_code" aria-label="验证码" placeholder="6 位数验证码" maxlength="6"
                       required>
    ...
    <div class="LoginForm">
        ...
        <div class="view login">
            <form method="POST">
                ...
                <div class="sns clearfix">
                    <label class="remember-me"><input type="checkbox" name="remember_me" checked
                    ...
                    <div class="sns-buttons">
                        <button type="button" class="wechat"><span class="ico sprite-global-icon-wechat-gray"></span>微信
                        </button>
                        <button type="button" class="weibo"><span class="ico sprite-global-icon-weibo-gray"></span>微博
                        </button>
...
<script type="text/template" class="unable-login-template">
    ...
    <div class="view reset-password">
        <form action="/resetpassword/email">
            ...
            <div class="input-wrapper verification-code">
                <input type="text" name="verification_code" aria-label="邮箱收到的" placeholder="邮箱收到的 6 位数验证码" maxlength="6"
                       required>
                <button type="button" class="send-code">重发验证码</button>
            </div>
            <div class="submit-wrapper">
