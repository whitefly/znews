...
<body class="zhi ">
        <div class="modal-dialog-bg" style="opacity: 0.5; width: 1366px; height: 1196px;"></div>
        <div class="modal-wrapper">
            <div class="modal-dialog absolute-position" style="width: 550px; left:20%">
        ...
        <div class="modal-wrapper" aria-hidden="true">
            <div class="modal-dialog absolute-position" style="width: 550px;left:70%">
                <div class="modal-dialog-title">
