        ...
        <#if user??>
            <div class="top-nav-profile">
                ...
                <ul class="top-nav-dropdown" id="top-nav-profile-dropdown">
                    ...
                    <li>
                        <a href="/questionFeed" tabindex="-1">
                            <i class="zg-icon zg-icon-dd-home"></i>关注的问题
                        </a>
                    </li>
...
<script>
    question = document.getElementById("zu-top-add-question");
    question.onclick = function () {
        questionAdd = window.Base.getClass("main.component.PopupAdd")
        questionAdd.show({})
    }
</script>